...
locals {
    ...
    minecraft_switch_access_group = "my-crafty-minecraft@googlegroups.com"
}
...
resource "google_compute_instance" "minecraft" {
  ...
  #  -e TYPE=FORGE -e FORGEVERSION=14.23.0.2552
  metadata_startup_script = "docker run -d -p 25565:25565 -e EULA=TRUE -v /var/minecraft:/data --name mc -e MEMORY=2G --rm=true itzg/minecraft-server:latest;"
